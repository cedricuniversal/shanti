...
print('MEAN CLUSTER mse on %i random samples: '%len(mse_values), np.array(mse_values_cluster).mean())
print('MEAN SVR mse on %i random samples: '%len(mse_values), np.array(mse_values_svr).mean())
